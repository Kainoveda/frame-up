    ...
    <div class="max-w-md w-full bg-white/10 backdrop-blur-sm border border-white/20 p-6 rounded-2xl shadow-xl">
      ...
      <form method="POST" action="#">
        ...
        <div class="mb-6">
          ...
          <input type="password" name="password" class="mt-1 block w-full h-8 pl-4 rounded-md border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500" required>
        </div>
